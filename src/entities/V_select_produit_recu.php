<?php
    ...
    /*==================Classe creer par Samane samane_ui_admin le 11-12-2019 15:09:39=====================*/
        ...
        class V_select_produit_recu extends Entitie
            {
    ...
    /*================== Constructor =====================*/
         ...
         $this->tablename="v_select_produit_recu";
                 $this->idp = 0 ;
                 $this->desi = "" ;
                 }
				...
				/*================== Liste v_select_produit_recu =====================*/
					public function liste(){
					  ...
					  public function insert(){
					    $this->setTablename("v_select_produit_recu");
					  ...
					  public function fldelete(){
					    $this->db->setTablename($this->tablename);
                               return $id_v_select_produit_recu = $this->db->updateTable($this->ObjecToarrayMaker());
                               }

				/*================== If v_select_produit_recu existe =====================*/
					public function ifV_select_produit_recuexiste($condition){
					    $this->db->setTablename($this->tablename);
