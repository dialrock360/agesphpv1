...
<script type="text/javascript" src="<?php echo $base_url; ?>assets/tableau.js"></script>
...
<script type="text/javascript" src="<?php echo $base_url; ?>assets/scriptuser.js"></script>
<script type="text/javascript" src="<?php echo $base_url; ?>assets/scriptfac.js"></script>
