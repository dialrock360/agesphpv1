...
,
               ...
               public function updatedepartement($departement){
                        $sql = "UPDATE departement  SET  departement.id_service =  '".$departement->getId_service()."' ,departement.nom_departement =  '".$departement->getNom_departement()."' ,departement.nbr_employee =  '".$departement->getNbr_employee()."' ,departement.jour_ouvrable =  '".$departement->getJour_ouvrable()."' ,departement.id_chefdepartement =  '".$departement->getId_chefdepartement()."' ,departement.info_departement =  '".$departement->getInfo_departement()."' ,departement.flag_departement =  '".$departement->getFlag_departement()."'   WHERE   departement.id =  ".$departement->getId()."  ";
