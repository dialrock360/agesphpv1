...
use libs\system\Model;
  use src\entities\Programme;
    ...
    /*==================Classe creer par Samane samane_ui_admin le 05-11-2019 10:13:20=====================*/
...
,
               ...
               public function updateprogramme($programme){
                        $sql = "UPDATE programme  SET  programme.nom_programme =  '".$programme->getNom_programme()."' ,programme.id_service =  '".$programme->getId_service()."' ,programme.date_programme =  '".$programme->getDate_programme()."' ,programme.datefin_programme =  '".$programme->getDatefin_programme()."' ,programme.nbr_projet_programme =  '".$programme->getNbr_projet_programme()."' ,programme.etat_programme =  '".$programme->getEtat_programme()."' ,programme.flag_programme =  '".$programme->getFlag_programme()."'   WHERE   programme.id =  ".$programme->getId()."  ";
