 ...
 use libs\system\Controller;
  ...
  class V_article_en_stock extends Controller{
    ...
    /*==================Attribut list=====================*/
             private  $v_article_en_stock;
             private  $v_article_en_stockdb;
   private  $db;

              public function __construct()
                 {
                        parent::__construct();
                 $this->v_article_en_stock = new V_article_en_stockEntity();
                 $this->v_article_en_stockdb = new V_article_en_stockDB();
                 $this->db = new DB();
                 }
    ...
    /*------------------Methode get--------------------=*/
       ...
       $this->v_article_en_stock->setId($id);
                    $data["v_article_en_stock"] = $this->v_article_en_stock->get();
    ...
    /*------------------Methode list--------------------=*/
            ...
            public function liste(){
                    $data["v_article_en_stocks"] = $this->v_article_en_stock->liste();
...
public function add(){
	//Récupération des données qui viennent du formulaire view/test/add.html (à créer)
            if(isset($_POST["valider"]))//"valider" est le name du champs submit du formulaire add.html
            {
                $data["ok"] = 0;
                if(isset($_POST["id"])) {
                    $this->v_article_en_stock->setPost($_POST,$_FILES);
                    $ok = $this->v_article_en_stock->insert();
                    $data["ok"] = $ok;
                }
...
public function update(){
	//Récupération des données qui viennent du formulaire view/test/add.html (à créer)
            if(isset($_POST["valider"]))//"valider" est le name du champs submit du formulaire add.html
            {
                ...
                if(isset($_POST["id"])) {
                    $this->v_article_en_stock->setPost($_POST,$_FILES);
                    $ok = $this->v_article_en_stock->update();
                    $data["ok"] = $ok;
                }
            return $this->liste();
            }else{
    ...
    /*------------------Methode list--------------------=*/
       ...
       $this->v_article_en_stock->setId($id);
            			//Supression
            			$this->v_article_en_stock->delete();
