    ...
    /*==================Classe creer par Samane samane_ui_admin le 05-12-2019 02:38:08=====================*/
        class SalarierDB extends Model {
				...
				/*================== Many to one salarier =====================*/
					public function listeSalarierByContratId($id){
					$sql = "SELECT * FROM salarier WHERE  salarier.contrat_id = ".$id."  ";
					                if($this->db != null)
					                    {
					                        return $this->db->query($sql)->fetchAll();
					                    }else{
				...
				/*================== One to many salarier =====================*/
					public function listeContratBySalarierId($contrat_id){
					$sql = "SELECT * FROM contrat WHERE  contrat.contrat_id = ".$contrat_id."  ";
					                if($this->db != null)
					                    {
					                        return $this->db->query($sql)->fetchAll();
					                    }else{
