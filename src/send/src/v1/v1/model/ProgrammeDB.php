    ...
    /*==================Classe creer par Samane samane_ui_admin le 05-12-2019 02:38:08=====================*/
        class ProgrammeDB extends Model {
				...
				/*================== Many to one programme =====================*/
					...
					public function listeProgrammeByModuleId($id){
					$sql = "SELECT * FROM programme WHERE  programme.modul_affecter = ".$id."  ";
					                if($this->db != null)
					                    {
					                        return $this->db->query($sql)->fetchAll();
					                    }else{
				...
				/*================== One to many programme =====================*/
					...
					public function listeModuleByProgrammeId($modul_affecter){
					$sql = "SELECT * FROM module WHERE  module.modul_affecter = ".$modul_affecter."  ";
					                if($this->db != null)
					                    {
					                        return $this->db->query($sql)->fetchAll();
					                    }else{
