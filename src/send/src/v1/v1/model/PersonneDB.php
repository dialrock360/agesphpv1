    ...
    /*==================Classe creer par Samane samane_ui_admin le 05-12-2019 02:38:08=====================*/
        class PersonneDB extends Model {
				...
				/*================== Many to one personne =====================*/
					public function listePersonneByServiceId($id){
					$sql = "SELECT * FROM personne WHERE  personne.id_service = ".$id."  ";
					                if($this->db != null)
					                    {
					                        return $this->db->query($sql)->fetchAll();
					                    }else{
				...
				/*================== One to many personne =====================*/
					public function listeServiceByPersonneId($id_service){
