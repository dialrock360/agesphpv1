...
,
               ...
               public function updatecordonnees($cordonnees){
                        $sql = "UPDATE cordonnees  SET  cordonnees.adress =  '".$cordonnees->getAdress()."' ,cordonnees.tel =  '".$cordonnees->getTel()."' ,cordonnees.email_personne =  '".$cordonnees->getEmail_personne()."' ,cordonnees.codepostal =  '".$cordonnees->getCodepostal()."' ,cordonnees.contact_urgent =  '".$cordonnees->getContact_urgent()."' ,cordonnees.etat_civile =  '".$cordonnees->getEtat_civile()."' ,cordonnees.nbr_conjoint =  '".$cordonnees->getNbr_conjoint()."' ,cordonnees.nbr_enfant =  '".$cordonnees->getNbr_enfant()."' ,cordonnees.info_conjoint =  '".$cordonnees->getInfo_conjoint()."' ,cordonnees.personne_id =  '".$cordonnees->getPersonne_id()."' ,cordonnees.flag_contact =  '".$cordonnees->getFlag_contact()."'   WHERE   cordonnees.id =  ".$cordonnees->getId()."  ";
