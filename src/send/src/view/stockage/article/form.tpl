<div class="row">
    <div class="col-xs-12">
        ...
        <!-- PAGE CONTENT BEGINS -->
            ...
            <form method="post" class="form-horizontal" action="{$url_base}Stokage/addArticle/multiple" enctype="multipart/form-data">
            ...
            <fieldset id="entitie" class="wrapper" >
                ...
                <table class="table table-striped table-bordered" id="tbl"> <caption>
                    ...
                    <tr  id="row_1">
                        ...
                        <td><textarea class="form-control" rows="2" name="fiche_technique[]" id="fiche_technique_1"></textarea></td>
                        <td>
                    ...
                    <tr  id="row_2">
                        ...
                        <td>
                            <textarea class="form-control" rows="2" name="fiche_technique[]" id="fiche_technique_2"></textarea>
                        </td>
                        <td>
...
//append the controls in the row
        ...
        var tblRow ='<tr id="row_' + rowcount + '">' +
            ...
            '<td><textarea class="form-control" rows="2" name="fiche_technique[]" id="fiche_technique_' + rowcount + '""></textarea></td>' +
            '<td>' +
