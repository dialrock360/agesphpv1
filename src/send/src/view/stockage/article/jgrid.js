...
function getarticle() {
    ...
    $.ajax({
        type: 'GET',
        url: varurl+'Article/liste2/'+$("#ids").val(),
        dataType: "json",
...
function getcategories(selector) {
    ...
    $.ajax({
        type: 'GET',
        url: varurl+'Categorie/liste2/'+$("#ids").val(),
        dataType: "json",
        //line added to get ajax response in sync
        async: false,
        success: function(data) {
...
grid_data=getarticle();
categ_data=getcategories('');
...
jQuery(function($) {
    ...
    jQuery(grid_selector).jqGrid({
        ...
        colModel:[
            ...
            {name:'path_photo',index:'path_photo',width:90, editable:false, sorttype:"file"},
            ...
            {name:'pxa_article',index:'pxa_article', width:150, sortable:false,editable: true,edittype:"number", editoptions:{min:0}},
            {name:'nom_categorie',index:'nom_categorie', width:90, editable: true,edittype:"select",editoptions:
                    {
