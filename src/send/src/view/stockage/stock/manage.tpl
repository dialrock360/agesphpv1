                        ...
                        <div class="widget-main padding-24">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div id="accordion" class="accordion-style1 panel-group">
                                    ...
                                    {include file='src/view/stockage/stock/transfert/modaltranfert.tpl'}
                                    {include file='src/view/stockage/stock/manage/viewnotifArticle.tpl'}
                                    <div   id="formartstk" >
                                        {include file='src/view/stockage/stock/article/formarticle_stock.tpl'}
                                    </div>
                                    {include file='src/view/stockage/stock/article/listearticle_stock.tpl'}
