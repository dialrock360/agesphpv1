                    ...
                    {foreach from=$stocks item=obj}
                        <tr id='tr_{$obj["id"]}'>
                            ...
                            <td>
                                ...
                                <a href="javascript:void(0)" data-toggle="modal" data-target="#modal-form"   data-id="{$obj["id"]}" id="addArticlestock"   class="btn btn-sm btn-success btn-white btn-round   " title="Ajouter articles">
