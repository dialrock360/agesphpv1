...
<script>
    ...
    function unSetTransfer(index)
    {
        ...
        $("#qnt_article_en_stock").val(qnt_trans_cible+qnt_article_en_stock_source);
        $("#qnt_article_en_stock_"+index).val(qnt_article_en_stock_cible-qnt_depot_cible);
        $("#qnt_trans").val(0);
        ...
        $(document).on('click', '.modaledit', function(e){
            ...
            $.ajax({
                ...
                .done(function(data){
                    ...
                    $('#id_article_en_stock').html(data.article_en_stock.id);
                    $('#valeur_article_en_stock').html(data.article_en_stock.valeur_article_en_stock);
                    ...
                    $('#pxv_conditionement_article').html(data.article_en_stock.pxv_conditionement_article);
                    ...
                    $.each(data.ls_en_stock , function (index, article_en_stock){
                        ...
                        var part3=    '        <div class="widget-box box-shadow">' +
                            ...
                            '                                    <label>' +
                            '                                        <input name="id_article_en_stock_[]" onclick="checkTransfer('+index+')" id="id_article_en_stock_'+index+'" value="'+article_en_stock.id_article_en_stock+'" type="radio" class="ace input-lg" />' +
                            '                                        <span class="lbl bigger-120"  id="nom_article_0">'+article_en_stock.nom_article+' <b>'+article_en_stock.nom_conditionement+'  <b></span>' +
                            '                                    </label>' +

                            '  <input   type="hidden" id="valeur_article_en_stock_'+index+'"   value="'+article_en_stock.valeur_article_en_stock+'" />   ' +
                            '   <input   type="hidden" id="max_qnt_article_en_stock_'+index+'"  value="'+article_en_stock.max_qnt_article_en_stock+'" />   ' +
                            '   <input   type="hidden" id="id_conditionement_article_'+index+'"  value="'+article_en_stock.id_conditionement_article+'" />   ' +
                            '  <input   type="hidden" id="pxv_conditionement_article_"  value="'+article_en_stock.pxv_conditionement_article+'"  />   ' +
                            ...
                            ' <p class="card-text"><small class="text-muted"><input class="form-control" type="text" id="qnt_article_en_stock_'+index+'" value="'+article_en_stock.qnt_article_en_stock+' "  readonly/></p>' +
                            ...
                            '                                                </a>' +
                            '                                                <a href="#"  class="btn btn-sm btn-white btn-primary">' +
                            ...
                            ' </div>' +
                            ' </div>' ;
                        var part2=    '  <div class="row" id="'+index+'">' +
                            '                                <div class="col-xs-5">' +
                            '                                    <label>' +
                            '                                        <input name="id_article_en_stock_[]" onclick="checkTransfer('+index+')" id="id_article_en_stock_'+index+'" value="'+article_en_stock.id_article_en_stock+'" type="radio" class="ace input-lg" />' +
                            '                                        <span class="lbl bigger-120"  id="nom_article_0">'+article_en_stock.nom_article+' <b>'+article_en_stock.nom_conditionement+'  <b></span>' +
                            ...
                            '                                                <br />' +
                            '                                                <a  href="javascript:void(0)"  onclick="unSetTransfer('+index+')" >' +
                            '                                                    <i class="ace-icon fa fa-undo bigger-230"></i>' +
                            '                                                </a>' +
                            ...
                            '                                <div class="col-xs-7">' +
                            '                                    <div>' +
                            '                                        <img width="32" height="32" alt="32x23" src="'+varurl2+'public/assets/images/gallery/'+article_en_stock.path_photo+'"  />' +
                            '                                        <div class="text">' +
                            '                                            <div class="inner">' +
                            '                                                <span  >'+article_en_stock.nom_stock+'</span><br />' +
                            '                                                <span   >1 '+data.article_en_stock.nom_conditionement+' = '+article_en_stock.multiplicateur+'  '+article_en_stock.nom_conditionement+' </span><br />' +
                            '                                                <span   >1 '+article_en_stock.nom_conditionement+' = '+article_en_stock.qnt_unite+'  '+article_en_stock.nom_unite_conditionement+' </span><br />' +
                            '                                                <span   > Valeur : '+article_en_stock.valeur_article_en_stock+'</span><br />' +
                            '                                                <hr />' +
                            '                                                <input class="form-control" type="text" id="qnt_article_en_stock_'+index+'" value="'+article_en_stock.qnt_article_en_stock+' "  readonly/>' +
