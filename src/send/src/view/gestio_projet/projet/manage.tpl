        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                ...
                <div class="project-details-wrap shadow-reset">
                    {include file='src/view/gestio_projet/projet/manage/_infoproject.tpl'}
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="project-details-tab">
                                ...
                                <div class="tab-content res-tab-content-project">
                                    {include file='src/view/gestio_projet/projet/manage/_tasklist.tpl'}
                                    {include file='src/view/gestio_projet/projet/manage/_teamlist.tpl'}
                                    {include file='src/view/gestio_projet/projet/manage/_membercommunication.tpl'}
                                    {include file='src/view/gestio_projet/projet/manage/_activity.tpl'}
            ...
            {include file='src/view/gestio_projet/projet/manage/_detailproject.tpl'}
        </div>
    </div>
</div>