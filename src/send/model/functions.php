...
/**********************************************************dELETERS////////////////////////////////////////////////////***********************************************************************************************************/
                                        require_once 'DB.php';
										function operator($sql,$sqltype='get',$returntype='all'){ 
...
function DELETMV() {
	...
	$sql="DELETE FROM `MOUVEMENT` WHERE FLAG=0 " ;
	operator($sql,$sqltype='update', 'null');
}
function DELETINV() { 
...
function DELETLOG() {
	...
	$sql="DELETE FROM `LOG` WHERE flag=0 " ;
	operator($sql,$sqltype='update', 'null');
}
function DELETPRO() {
	  
	$sql="DELETE FROM `PRODUIT` WHERE FLAG=2" ;
	operator($sql,$sqltype='update', 'null');
}
/*********************************************************************************************************************************************************************/
