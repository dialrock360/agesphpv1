...

{
	...
	$resref = 'select * from facture where DATEF>= "'.$dated.'" and DATEF<="'.$dated.'" and TYPEF="'.$facture.'"  ORDER BY IDFA'  ;
...

{
    ...
    $resref = 'select * from v_facture where DATE_DEL>= "'.$dated.'" and DATE_DEL<="'.$dated.'" and NOMMV="'.$facture.'"and IDFA="'.$idfa.'" '  ;
	$countref=facoperator($resref, 'get', 'all');
...

{
	...
	$resref = 'select * from v_facture where DATE_DEL>= "'.$dateI.'" and DATE_DEL<="'.$dateF.'" and NOMMV="'.$facture.'"and IDFA="'.$idfa.'" '  ;
...

{
	...
	$resref = 'select * from v_facture where DATE_DEL>= "'.$dateI.'" and DATE_DEL<="'.$dateF.'" and NOMMV="'.$facture.'"and FLAG=0 '  ;
	   $countref=facoperator($resref, 'get', 'all');
