...
<script>
        ...
        bootbox.dialog({
            ...
            buttons: {
                danger: {
                    ...
                    callback: function() {
                        ...
                        $.ajax({
                            ...
                            .fail(function(){
                                $('#error').html('<i class="glyphicon glyphicon-info-sign"></i> Something went wrong, Please try again...');
                ...
                success: {
                    ...
                    callback: function() {
                        window.location.href=curenpage;
                    }
                }
            }
        });
    ...
    function setLine(x){
        ...
        for(var i=0; i<ids.length; i++) {
            ...
            alert(b);
            c ='<td>' +
                '<input type="text" name="nom_'+a+'" id="Champ2Design_'+a+'"  value="'+res[3]+'" style="text-align:left;" class="form-control"/>' +
                '<input type="hidden" name="idp_'+a+'" id="Champ2Idp_'+a+'"  value="'+res[0]+'"/>' +
                '<input type="hidden" name="idfac_'+a+'" id="Champ2Idf_'+a+'" value="-1"/>' +
                '<input type="hidden" name="row_'+a+'" id="Champ2Row_'+a+'" value="'+a+'"/>' +
                '</td>'+"\n";
            c+=' <td><input type="text" name="condis_'+a+'" id="Champ2Condis_'+a+'"  value="'+res[14]+'" style="text-align:left;" class="form-control" /></td>'+"\n";
            c+=' <td><input type="text" name="prix_'+a+'" id="Champ2TarifHT_'+a+'"  value="'+res[0]+'" style="text-align:right;" class="form-control"/></td>'+"\n";
            c+=' <td><input type="number" step="0.5" min="0" max="" name="qnte_'+a+'" id="Champ2Qte_'+a+'" value=""  style="text-align:right;" class="form-control" /></td>'+"\n";
            c+=' <td><input type="text" name="ptotal_'+a+'" id="Champ2Result_'+a+'" value="1,00" style="text-align:right;" class="form-control" /></td>'+"\n";
            c+=' <td><button class="btn btn-xs btn-white btn-default btn-round INPUTFACT" type="button" onclick="suprLine('+a+')"><i class="ace-icon fa fa-times red2"></i>Suppr</button></td>'+"\n";

            d+='<tr>'+"\n"+c+"\n"+'</tr>'+"\n";
            $('#manligneCalcul').append(d);
        }
        ...
        //    $('#demo').html(res);
        // {"IDP 0":"233","IDC 1":"14","ID_CAT 2":"1","DESI 5":"CHAMBRE JOUNEE CLIM","PHOTO 6":"...",
        // "PRIXA 7":"0","PRIXV 8":"15000","QNT 9":"1","COMPOSER 10 ":"0","FTECH 11":"\r\n ",
        // "FLAG 12":"0","IDFA 13":"1","NOM_CAT 14":"CHAMBRES 15","ACHAT 16":"0",
        // "VENTE 17":"1","COMPT 18":"0","NOMF 19":"AUBERGE","COLOR 20":"#1E90FF",
        // "NOMC 21":"Unit\u00e9"}
    ...
    //    $('#demo').html(res);
       // {"IDP":"233","IDC":"14","ID_CAT":"1","DESI":"CHAMBRE JOUNEE CLIM","PHOTO":"...","PRIXA":"0","PRIXV":"15000","QNT":"1","COMPOSER":"0","FTECH":"\r\n ","FLAG":"0","IDFA":"1","NOM_CAT":"CHAMBRES","ACHAT":"0","VENTE":"1","COMPT":"0","NOMF":"AUBERGE","COLOR":"#1E90FF","NOMC":"Unit\u00e9"}
