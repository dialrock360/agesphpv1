<?php
   ...
   /*==================================================
    ...
    /*==================Classe creer par Samane samane_ui_admin le 10-12-2019 07:39:18=====================*/
        ...
        class V_select_produit_comptabiliser extends Entitie
            {
    ...
    /*================== Constructor =====================*/
         ...
         $this->tablename="v_select_produit_comptabiliser";
                 $this->idp = 0 ;
                 $this->desi = "" ;
                 }
				...
				/*================== Liste v_select_produit_comptabiliser =====================*/
					public function liste(){
					  ...
					  public function insert(){
					    $this->setTablename("v_select_produit_comptabiliser");
					  ...
					  public function fldelete(){
					    $this->db->setTablename($this->tablename);
                               return $id_v_select_produit_comptabiliser = $this->db->updateTable($this->ObjecToarrayMaker());
                               }

				/*================== If v_select_produit_comptabiliser existe =====================*/
					public function ifV_select_produit_comptabiliserexiste($condition){
					    $this->db->setTablename($this->tablename);
