...
<div class="col-sm-6">
                                <span class="block input-icon input-icon-right">
                                    <input type="text" class="form-control" value="Nom de La Matière"  name="nom" onkeyup="matFunction()" required />
                                    <input type="text" class="form-control" value="id de La Matière"  name="idm"  required />
