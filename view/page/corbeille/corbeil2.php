        ...
        <form method="post" name="frm" >
            ...
            <div class="table-responsive">
                <table id='' class='display'>
                    ...
                    $query = "SELECT * FROM UTILISATEUR WHERE FLAG=2";
                    ...
                    $query = "SELECT * FROM CONDIS WHERE FLAG=2 ORDER BY NOMC";
                    $stmt = $db_con->prepare( $query );
                    $stmt->execute();
                    while ($row=$stmt->fetch(PDO::FETCH_ASSOC) ) {
                        extract($row);
                    ...
                    $query = "SELECT * FROM FAMILLE WHERE FLAG=2 ORDER BY DESI ";
                    $stmt = $db_con->prepare( $query );
                    $stmt->execute();
                    while ($row=$stmt->fetch(PDO::FETCH_ASSOC) ) {
                        extract($row);
                    ...
                    <?php
                    ///SELECT `IDFA`, `DESI`, `NATURE`, `FLAG` FROM `FAMILLE` WHERE 1
                    $query = "SELECT * FROM PRODUIT WHERE FLAG=2 ORDER BY DESI ";
                    $stmt = $db_con->prepare( $query );
                    $stmt->execute();
                    while ($row=$stmt->fetch(PDO::FETCH_ASSOC) ) {
                        extract($row);
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="delete_product" data-id="<?php echo $IDP; ?>" href="javascript:void(0)" data-toggle="tooltip" title="Supprimer!">
                                    <i class="glyphicon glyphicon-trash"></i>
                                </a></td>
                        </tr>
                    <?php
                    ...
                    $query = "SELECT * FROM CATEGORIE WHERE FLAG=2 ORDER BY NOM_CAT ";
                    $stmt = $db_con->prepare( $query );
                    $stmt->execute();
                    while ($row=$stmt->fetch(PDO::FETCH_ASSOC) ) {
                        extract($row);
                    ...
                    $query = "SELECT * FROM MOUVEMENT WHERE FLAG=2 ORDER BY NOMMV ";
                    $stmt = $db_con->prepare( $query );
                    $stmt->execute();
                    while ($row=$stmt->fetch(PDO::FETCH_ASSOC) ) {
                        extract($row);
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="delete_fac" data-id="<?php echo $IDMV; ?>" href="javascript:void(0)" data-toggle="tooltip" title="Supprimer!">
                                    <i class="glyphicon glyphicon-trash"></i>
                                </a></td>
                        </tr>
                    <?php
