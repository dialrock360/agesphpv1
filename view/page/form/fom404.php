...
<style>
    ...
    /*Variables */
    #page404 .left-section .inner-content {
        position: absolute;
        top: 50%;
    ...
    #page404     .left-section, .right-section {
        position: relative;
    }
    ...
    #page404   .svgimg .bench-legs {
        fill: #0C0E10;
    }
    #page404  .svgimg .top-bench, .svgimg .bottom-bench {
        stroke: #0C0E10;
        stroke-width: 1px;
        fill: #5B3E2B;
    }
    #page404   .svgimg .bottom-bench path:nth-child(1) {
        fill: #432d20;
    }
    #page404    .svgimg .lamp-details {
        fill: #202425;
    }
    #page404    .svgimg .lamp-accent {
        fill: #2c3133;
    }
    #page404  .svgimg .lamp-bottom {
        fill: linear-gradient(#202425, #0C0E10);
    }
    #page404  .svgimg .lamp-light {
        fill: #EFEFEF;
    }
...
<div class="background" id="page404">
...
<div class="container">
    <div class="left-section">
        <div class="inner-content">
            ...
            <p class="subheading"><span style="color:rgb(0, 255, 255)"><span style="background-color:rgb(0, 0, 0)"><?php echo $message404; ?></span></span></p>
        </div>
    </div>
