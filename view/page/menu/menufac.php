...
if($fac=='proforma'){
    ...
    <ul class="nav nav-tabs" id="myTabr">
        ...
        <li >
            <a href="?file=page/recu/table">
                <img src="assets/images/icon/facturepro.png" class="img-responsive" alt="LISTE FACTURE" style="float: left">

                LISTE DEPENSES
                &nbsp;<br>
                <span class="badge badge-danger">
            <?php $fact='proforma';Count_Mvm($fact); ?>
            </span>
            </a>
        </li>
        <li >
            <a href="?file=page/recu">
                <img src="assets/images/icon/addfacturepro.png" class="img-responsive" alt="LISTE FACTURE" style="float: left">
                NOUVEAU RECU
                <br><br>
            </a>
